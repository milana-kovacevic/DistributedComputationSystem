...
\begin{figure}[!ht]
  \centering
  \frame{\includegraphics[width=0.7\textwidth]{./images/succeeded_failed_jobs.png}}
...
Na slici \ref{fig:faktor_ubrzanja} se nalazi grafički prikaz faktora ubrzanja distribuiranog izvršavanja, u odnosu na sekvencijalno izvršavanje.

\begin{figure}[!ht]
  \centering
  \frame{\includegraphics[width=0.8\textwidth]{./images/perf_faktor_ubrzanja.png}}
  \caption{Faktor ubrzanja dobijen distribuiranjem}
  \label{fig:faktor_ubrzanja}
\end{figure}
