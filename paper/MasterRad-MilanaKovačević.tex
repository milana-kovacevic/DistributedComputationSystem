...
\section{Uzbunjivači}
Korisnik koji ima pravo logovima i metrikama može da napravi uzbunjivača (eng. \emph{Alert}) koji bi na osnovu dostupnih metrika i logova, definisao situacije u kojima treba da nas uzbuni kao administratora servisa. Problemi u produkcionom okruženju se javljaju, i u tim slučajevima je cilj što pre reagovati i obezbediti da sistem bude zdrav i u funkciji.
U nastavku se nalazi primer upozoranja u slučaju velikog broja grešaka na servisu.
