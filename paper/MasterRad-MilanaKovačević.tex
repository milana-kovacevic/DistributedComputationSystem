...
\section{Platforma \emph{Microsoft Azure}}
...
\subsection{Integracija sa platofrmom emph{Microsoft Azure}}
...
Za pregled logova korišćen je servis \emph{Azure Log Analytics} dostupan u okviru servisa \emph{Azure Monitor}. Ovaj alat pruža moćan deskriptivni jezik kojim se mogu pretraživati, filtrirati, sortirati i analizirati logovi. Rezultate upita je takođe moguće vizuelizovati u vidu grafikona.
