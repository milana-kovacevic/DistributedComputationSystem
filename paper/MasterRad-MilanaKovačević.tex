...
Na slici \ref{fig:clusterunhealthy} je prikazan pogled na \emph{Insight} sekciju pripadajućeg klastera u slučaju nezdravog Frontend servisa.
...
Za pregled logova korišćen je servis \emph{Azure Log Analytics} dostupan u okviru \emph{Azure Monitor} servisa. Ovaj alat pruža moćan deskriptivni jezik kojim se mogu pretraživati, filtrirati, sortirati i analizirati logovi. Rezultate upita je takođe moguće vizuelizovati u vidu grafikona.
