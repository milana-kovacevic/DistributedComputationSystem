...
U nastavku, na slici \ref{fig:controlnode_yaml} je prikazana datoteka yaml  koja definiše kreiranje aplikacije Control Node na klasteru Kubernetes.
        ...
        backend:
          service:
            ...
            port:
              number: 80
\end{lstlisting}
\caption{Kreiranje objekta ingress za pristup CtrlN preko DNS imena i https protokola}
