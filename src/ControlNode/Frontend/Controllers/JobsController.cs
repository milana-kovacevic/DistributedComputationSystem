...
namespace ControlNode.Frontend.Controllers
{
    ...
    public class JobsController : ControllerBase
    {
        ...
        public async Task<ActionResult<Job>> PostJob([FromBody] JobRequestData inputData)
        {
            ...
            {
                return BadRequest(FrontendExceptionMessages.InputDataNotProvided);
            }
            ...
            if (!_jobManager.TryAddJob(addedJob.Entity))
            {
                ...
                return Problem(FrontendExceptionMessages.SystemTooBusy, statusCode: (int)StatusCodes.Status503ServiceUnavailable);
            }
